...
* The original package name 'com.example.spring-gral' is invalid and this project uses 'com.example.springgral' instead.
...
```
$ docker run --rm -p 8080:8080 spring-gral:0.0.1-SNAPSHOT
```
